<?php
class InitSmartyPlugin extends \Yaf\Plugin_Abstract {
     ...
     * @param  \Yaf\Request_Abstract  $request  [description]
     * @param  \Yaf\Response_Abstract $response [description]
    ...
    public function routerShutdown(\Yaf\Request_Abstract $request, \Yaf\Response_Abstract $response) {
        ...
        $smarty= new \Yaf\Config\Ini(APP_PATH . '/conf/application.ini', 'smarty');
        ...
        \Yaf\Dispatcher::getInstance()->setView($smarty)->autoRender(false);
    }
